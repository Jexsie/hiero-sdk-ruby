...
# Source: services/consensus_service.proto for package 'proto'
...
module Proto
  module ConsensusService
    ...
    class Service
      ...
      self.service_name = 'proto.ConsensusService'
      ...
      rpc :createTopic, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      # Update an HCS topic.
      # <p>
      ...
      rpc :updateTopic, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      # Delete an HCS topic.
      # <p>
      ...
      rpc :deleteTopic, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      ...
      rpc :submitMessage, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      ...
      rpc :getTopicInfo, ::Proto::Query, ::Proto::Response
    end
