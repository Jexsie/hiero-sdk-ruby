...
# Source: services/smart_contract_service.proto for package 'proto'
...
module Proto
  module SmartContractService
    ...
    class Service
      ...
      self.service_name = 'proto.SmartContractService'
      ...
      rpc :createContract, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      ...
      rpc :updateContract, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      ...
      rpc :contractCallMethod, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      ...
      rpc :contractCallLocalMethod, ::Proto::Query, ::Proto::Response
      # *
      # A standard query to obtain detailed information for a smart contract.
      rpc :getContractInfo, ::Proto::Query, ::Proto::Response
      # *
      # A standard query to read the current bytecode for a smart contract.
      rpc :ContractGetBytecode, ::Proto::Query, ::Proto::Response
      # *
      ...
      rpc :deleteContract, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      ...
      # If this call succeeds then all subsequent calls to that smart
      # contract SHALL fail.<br/>
      rpc :systemDelete, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      ...
      rpc :systemUndelete, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      ...
      rpc :callEthereum, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      # Update zero or more slots of an EVM hook's storage.
      rpc :hookStore, ::Proto::Transaction, ::Proto::TransactionResponse
    end
