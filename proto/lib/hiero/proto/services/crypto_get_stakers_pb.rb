...
module Proto
  CryptoGetStakersQuery = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("proto.CryptoGetStakersQuery").msgclass
  ProxyStaker = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("proto.ProxyStaker").msgclass
  AllProxyStakers = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("proto.AllProxyStakers").msgclass
  CryptoGetStakersResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("proto.CryptoGetStakersResponse").msgclass
end
