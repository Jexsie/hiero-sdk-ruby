...
# Source: services/file_service.proto for package 'proto'
...
module Proto
  module FileService
    ...
    class Service
      ...
      self.service_name = 'proto.FileService'

      # *
      # Create a file in HFS.
      rpc :createFile, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      # Update a file in HFS.
      rpc :updateFile, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
