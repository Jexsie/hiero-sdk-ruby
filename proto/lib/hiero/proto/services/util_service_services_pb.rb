...
# Source: services/util_service.proto for package 'proto'
...
module Proto
  module UtilService
    ...
    class Service
      ...
      self.service_name = 'proto.UtilService'
      ...
      rpc :prng, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      ...
      rpc :atomicBatch, ::Proto::Transaction, ::Proto::TransactionResponse
    end
