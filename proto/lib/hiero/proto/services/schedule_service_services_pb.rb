...
# Source: services/schedule_service.proto for package 'proto'
...
module Proto
  module ScheduleService
    ...
    class Service
      ...
      self.service_name = 'proto.ScheduleService'
      ...
      rpc :createSchedule, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      ...
      rpc :signSchedule, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      ...
      rpc :deleteSchedule, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      # Retrieve the metadata for a schedule.
      rpc :getScheduleInfo, ::Proto::Query, ::Proto::Response
    end
