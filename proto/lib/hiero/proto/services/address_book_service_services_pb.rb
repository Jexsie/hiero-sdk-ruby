...
# Source: services/address_book_service.proto for package 'proto'
...
module Proto
  module AddressBookService
    ...
    class Service
      ...
      self.service_name = 'proto.AddressBookService'
      ...
      rpc :createNode, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      ...
      # <p>
      # Hedera governing council authorization is REQUIRED for this transaction.
      rpc :deleteNode, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      ...
      rpc :updateNode, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      ...
      rpc :createRegisteredNode, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      ...
      rpc :deleteRegisteredNode, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      ...
      # node state as requested.
      rpc :updateRegisteredNode, ::Proto::Transaction, ::Proto::TransactionResponse
    end
