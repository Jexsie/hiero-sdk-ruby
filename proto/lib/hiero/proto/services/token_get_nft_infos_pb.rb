...
module Proto
  TokenGetNftInfosQuery = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("proto.TokenGetNftInfosQuery").msgclass
  TokenGetNftInfosResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("proto.TokenGetNftInfosResponse").msgclass
end
