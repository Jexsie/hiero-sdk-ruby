...
# Source: services/token_service.proto for package 'proto'
...
module Proto
  module TokenService
    ...
    class Service
      ...
      self.service_name = 'proto.TokenService'

      # *
      # Create a new token.
      rpc :createToken, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      # Update a token.
      rpc :updateToken, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      ...
      rpc :mintToken, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      ...
      # a list of specific non-fungible/unique tokes, but
      # MUST NOT specify both.
      rpc :burnToken, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      # Delete a token.
      rpc :deleteToken, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      ...
      # a list of specific non-fungible/unique tokes, but
      # MUST NOT specify both.
      rpc :wipeTokenAccount, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      # Freeze the transfer of tokens to or from an identified Account.
      rpc :freezeTokenAccount, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      # Unfreeze the transfer of tokens to or from an identified Account.
      rpc :unfreezeTokenAccount, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      # Assert that KYC requirements are met for a specific account with
      # respect to a specific token.
      rpc :grantKycToTokenAccount, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      # Assert that KYC requirements are _not_ met for a specific account with
      # respect to a specific token.
      rpc :revokeKycFromTokenAccount, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      # Associate one or more tokens to an account.
      rpc :associateTokens, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      # Dissociate one or more tokens from an account.
      rpc :dissociateTokens, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      # Update the custom fee schedule for a token.
      rpc :updateTokenFeeSchedule, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      ...
      rpc :getTokenInfo, ::Proto::Query, ::Proto::Response
      # *
      ...
      rpc :getTokenNftInfo, ::Proto::Query, ::Proto::Response
      # *
      # Pause a token.
      rpc :pauseToken, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      # Unpause (resume) a token.
      rpc :unpauseToken, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      ...
      rpc :updateNfts, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      ...
      # </li>
      rpc :rejectToken, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      ...
      rpc :airdropTokens, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      # Cancel one or more pending airdrops.
      # <p>
      # This transaction MUST be signed by _each_ account *sending* an
      # airdrop to be canceled.
      rpc :cancelAirdrop, ::Proto::Transaction, ::Proto::TransactionResponse
      # *
      ...
      rpc :claimAirdrop, ::Proto::Transaction, ::Proto::TransactionResponse
    end
